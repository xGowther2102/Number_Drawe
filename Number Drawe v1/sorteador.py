...
print(colored('===============================================================================', 'green'))
premio = input(colored('||Ingrese el premio: ', 'yellow'))
print(colored('===============================================================================', 'green'))
...
espera = time.sleep(1)
while cant > 0:
    numero = random.randrange(1,100) #Rango de numeros ya sea 10 boletos o 100 / Number range either 10 tickets or 100
...
print(colored('El numero ganador se mostrara en menos de 2 minutos', 'cyan')) # Tiempo Aproximado, usted puede cambiar la descripcion / Approximate time, you can change the description
os.system('cls')
print(colored('===============================================================================', 'green'))
time.sleep(2)
#Barra de progreso 1 / Progress bar 1
bar1 = ChargingBar(colored('Buscando Numero Ganador:','yellow'), max=100)#Puedes cambiar la descripcion y color de la letra / You can change the description and color of the letter
...
bar2 = ChargingBar(colored('Finalizando:','yellow'), max=100)
for num in range(100):
...
bar3 = ChargingBar(colored('Mostrando Numero Ganador:', 'yellow') , max=100)
for num in range(100):
...
print('Numero Ganador:', colored(sorteo,'red'))
time.sleep(2.5)
#Insertar Nombre del Ganador / insert the name of the winner
Ganador = input(colored('||Nombre del Ganador/a: ', 'yellow'))

time.sleep(2.5)

print('Premio: ', colored(premio, 'red')) #Muestra el premio / show the reward
time.sleep(2.5)
os.system('cls')
#Muestra Nombre, Numero y premio / displays name, number and award
print(colored('===============================================================================', 'green'))
print('||¡Felicidades ', colored(Ganador,'cyan'), '-')
print('Con numero:',  colored(sorteo,'cyan'), ". Te ganaste un/a:", colored(premio, 'cyan'))
time.sleep(2)
...
print(" ")
time.sleep(3)
print(colored("\n" 'Proximo sorteo: 30 de febrero de 2099', 'cyan'))
print(" ")
time.sleep(3)
print(colored('===============================================================================', 'green'))
time.sleep(10)
